...
public class GitStepByStepGuide {
    public static void main(String[] args) {
        ...
        String step_12_1 = "If change are required, the i have to modify my local branch, and perform a git commit amend";
        ...
        String step14 = "Go to intellij Idea, and checkout the master branch";
